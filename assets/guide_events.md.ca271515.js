import{_ as s,c as n,o as a,a as e}from"./app.13f391c7.js";const A=JSON.parse('{"title":"Events","description":"","frontmatter":{},"headers":[{"level":2,"title":"on-accept-all","slug":"on-accept-all"},{"level":2,"title":"on-decline-all","slug":"on-decline-all"},{"level":2,"title":"on-save-preferences","slug":"on-save-preferences"}],"relativePath":"guide/events.md","lastUpdated":null}'),l={name:"guide/events.md"},o=e(`<h1 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-hidden="true">#</a></h1><h2 id="on-accept-all" tabindex="-1">on-accept-all <a class="header-anchor" href="#on-accept-all" aria-hidden="true">#</a></h2><p>This event is dispatched when the user clicks the Accept All button. You can call your own handler to do whatever you might do in this case:</p><div class="language-js"><button class="copy"></button><span class="lang">js</span><pre><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">script</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">setup</span><span style="color:#89DDFF;">&gt;</span></span>
