...
<template>
  <teleport :to="target">
    ...
    >
      ...
      >
        <div>
          <slot :description="description" :title="title" name="header">
        ...
        >
          ...
          >
            ...
            <CookieButton class="whitespace-nowrap" @click="handleAcceptAll">
              {{ acceptAllLabel }}
            </CookieButton>
          </slot>
        </div>
              ...
              <div class="relative bg-white dark:bg-gray-800 rounded-lg">
                ...
                <header class="p-6">
                  <slot name="modal-title">
                    ...
                    <hr
                      class="border-t-2 border-gray-100 dark:border-gray-700 mt-6"
                    />
                  </slot>
                </header>

                <main class="px-6 max-h-96 overflow-y-auto">
                ...
                <footer class="px-6 py-6">
                  ...
                  >
                    <hr
                      class="border-t-2 border-gray-100 dark:border-gray-700 mb-6"
                    />
